      ...
      if (($.inArray(data[i]['senderId'], senderIdList)) == -1) {
        ...
        (function(messageNum, read) {
          $.ajax({
            ...
            if(read) {
              $('#notificationsBody').insertAt(messageNum, '<a class="msg" href="/message/' + senderIdList[messageNum] +'"><div class="readmsg"><span id="sendername">' + senderName + '</span><br><br><span id="msgpreview">' + message[messageNum] +'</span></div></a>');
            }
            else {
              $('#notificationsBody').insertAt(messageNum, '<a class="msg" href="/message/' + senderIdList[messageNum] +'"><div class="unreadmsg"><span id="sendername">' + senderName + '</span><br><br><span id="msgpreview">' + message[messageNum] +'</span></div></a>');
            }
          });
        })(messageNum, read);
        messageNum++;
